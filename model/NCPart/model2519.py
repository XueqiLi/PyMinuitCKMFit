# Filename: model2121h2p1_No115.py
import numpy as np
from ModularForm import *
numberOfParams = 11
def ELMatrix(params):
    g2, g3, g4, g5, g6, a2, a3, a4, a5, n3, n4, tr, ti = params
    t = tr + 1j * ti 
    Y2k4_t=Y2k4(t)
    Y2pk18_t=Y2pk18(t)
    Y1k20_t=Y1k20(t)
...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[-(Y2pk10_t[1]), -(Y2pk10_t[0]), -(a4*Y2k8_t[1])], [-(Y2pk10_t[0]), Y2pk10_t[1], a4*Y2k8_t[0]], [a3*Y2IIk16_t[0] + a2*Y2Ik16_t[0], a3*Y2IIk16_t[1] + a2*Y2Ik16_t[1], a5*Y1hpk14_t[0]]]
