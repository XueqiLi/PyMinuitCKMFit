...
def NLMatrix(params):
    ...
    Y1k12_t=Y1k12(t)
    Y2k12_t=Y2k12(t)
    return [[a2*Y1k8_t[0] - Y2k8_t[0], Y2k8_t[1], a4*Y2k12_t[0]], [Y2k8_t[1], a2*Y1k8_t[0] + Y2k8_t[0], a4*Y2k12_t[1]], [a3*Y2k8_t[0], a3*Y2k8_t[1], a5*Y1k12_t[0]]]
