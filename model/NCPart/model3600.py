# Filename: model2121hp2p1hp_No22.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk14_t=Y2pk14(t)
    Y1hpk14_t=Y1hpk14(t)
    return [[a2*Y1hpk14_t[0] - Y2pk14_t[1], -(Y2pk14_t[0]), a4*Y2k12_t[0]], [-(Y2pk14_t[0]), a2*Y1hpk14_t[0] + Y2pk14_t[1], a4*Y2k12_t[1]], [a3*Y2pk14_t[0], a3*Y2pk14_t[1], a5*Y1pk12_t[0]]]
