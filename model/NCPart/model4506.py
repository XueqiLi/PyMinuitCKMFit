# Filename: model2121p2p1_No48.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y1hpk14_t=Y1hpk14(t)
    Y2pk18_t=Y2pk18(t)
    return [[a2*Y1hpk14_t[0] - Y2pk14_t[1], -(Y2pk14_t[0]), a4*Y2pk18_t[0]], [-(Y2pk14_t[0]), a2*Y1hpk14_t[0] + Y2pk14_t[1], a4*Y2pk18_t[1]], [a3*Y2k8_t[0], a3*Y2k8_t[1], a5*Y1pk12_t[0]]]
