# Filename: model212p12p1_No157.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk18_t=Y2pk18(t)
    Y1k20_t=Y1k20(t)
    return [[Y2k8_t[1], -(a2*Y1k8_t[0]) + Y2k8_t[0], a4*Y2pk18_t[1]], [a2*Y1k8_t[0] + Y2k8_t[0], -(Y2k8_t[1]), -(a4*Y2pk18_t[0])], [a3*Y2pk10_t[1], -(a3*Y2pk10_t[0]), a5*Y1k20_t[0]]]
