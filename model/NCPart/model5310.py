# Filename: model212p121h_No29.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik20_t=Y2Ik20(t)
    Y2IIk20_t=Y2IIk20(t)
    return [[a2*Y1hpk14_t[0] - Y2pk14_t[1], -(Y2pk14_t[0]), a5*Y2k12_t[0]], [-(Y2pk14_t[0]), a2*Y1hpk14_t[0] + Y2pk14_t[1], a5*Y2k12_t[1]], [-(a4*Y2IIk20_t[1]) - a3*Y2Ik20_t[1], a4*Y2IIk20_t[0] + a3*Y2Ik20_t[0], a6*Y1hpk18_t[0]]]
