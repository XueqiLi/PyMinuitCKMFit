# Filename: model212p12p1hp_No90.py
import numpy as np
from ModularForm import *
numberOfParams = 8
def ELMatrix(params):
    g2, g3, a2, a3, n2, n4, n5, n6, tr, ti = params
    t = tr + 1j * ti 
    Y2pk10_t=Y2pk10(t)
    Y2k12_t=Y2k12(t)
    Y1k20_t=Y1k20(t)
...
def NLMatrix(params):
    ...
    Y2k4_t=Y2k4(t)
    Y2pk10_t=Y2pk10(t)
    return [[0, -(Y1k0_t[0]), a3*Y2pk10_t[1]], [Y1k0_t[0], 0, -(a3*Y2pk10_t[0])], [a2*Y2k4_t[0], a2*Y2k4_t[1], 0]]
