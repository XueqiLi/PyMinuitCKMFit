...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[a3*Y1k12_t[0] - Y2k12_t[0], -(a2*Y1pk12_t[0]) + Y2k12_t[1], -(a6*Y2k4_t[1])], [a2*Y1pk12_t[0] + Y2k12_t[1], a3*Y1k12_t[0] + Y2k12_t[0], a6*Y2k4_t[0]], [a5*Y2IIk16_t[0] + a4*Y2Ik16_t[0], a5*Y2IIk16_t[1] + a4*Y2Ik16_t[1], 0]]
