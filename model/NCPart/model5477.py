# Filename: model212p121hp_No18.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[a2*Y1hpk14_t[0] - Y2pk14_t[1], -(Y2pk14_t[0]), a5*Y2k12_t[0]], [-(Y2pk14_t[0]), a2*Y1hpk14_t[0] + Y2pk14_t[1], a5*Y2k12_t[1]], [a4*Y2IIk16_t[0] + a3*Y2Ik16_t[0], a4*Y2IIk16_t[1] + a3*Y2Ik16_t[1], 0]]
