# Filename: model2121h21h_No61.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk18_t=Y2pk18(t)
    Y1pk20_t=Y1pk20(t)
    return [[a2*Y1k8_t[0] - Y2k8_t[0], Y2k8_t[1], a4*Y2pk18_t[1]], [Y2k8_t[1], a2*Y1k8_t[0] + Y2k8_t[0], -(a4*Y2pk18_t[0])], [a3*Y2pk10_t[1], -(a3*Y2pk10_t[0]), a5*Y1pk20_t[0]]]
