# Filename: model2121p2p1p_No95.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y1hk18_t=Y1hk18(t)
    Y1hpk18_t=Y1hpk18(t)
    return [[a2*Y1hpk18_t[0] - Y2pk18_t[1], -(a3*Y1hk18_t[0]) - Y2pk18_t[0], a5*Y2pk10_t[0]], [a3*Y1hk18_t[0] - Y2pk18_t[0], a2*Y1hpk18_t[0] + Y2pk18_t[1], a5*Y2pk10_t[1]], [-(a4*Y2k12_t[1]), a4*Y2k12_t[0], 0]]
