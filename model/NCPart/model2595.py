# Filename: model2121h2p1_No48.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik20_t=Y2Ik20(t)
    Y2IIk20_t=Y2IIk20(t)
    return [[0, 0, -(a4*Y2IIk20_t[1]) - a3*Y2Ik20_t[1]], [0, 0, a4*Y2IIk20_t[0] + a3*Y2Ik20_t[0]], [a2*Y2IIk16_t[0] + Y2Ik16_t[0], a2*Y2IIk16_t[1] + Y2Ik16_t[1], 0]]
