# Filename: model212p1hp21h_No43.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2IIk16_t=Y2IIk16(t)
    Y1k20_t=Y1k20(t)
    return [[-(Y2pk10_t[1]), -(Y2pk10_t[0]), a4*Y2pk14_t[0]], [-(Y2pk10_t[0]), Y2pk10_t[1], a4*Y2pk14_t[1]], [-(a3*Y2IIk16_t[1]) - a2*Y2Ik16_t[1], a3*Y2IIk16_t[0] + a2*Y2Ik16_t[0], a5*Y1k20_t[0]]]
