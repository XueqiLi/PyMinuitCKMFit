# Filename: model2121h21h_No79.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y1pk12_t=Y1pk12(t)
    Y2k12_t=Y2k12(t)
    return [[a3*Y1k12_t[0] - Y2k12_t[0], -(a2*Y1pk12_t[0]) + Y2k12_t[1], a5*Y2pk10_t[1]], [a2*Y1pk12_t[0] + Y2k12_t[1], a3*Y1k12_t[0] + Y2k12_t[0], -(a5*Y2pk10_t[0])], [a4*Y2pk10_t[1], -(a4*Y2pk10_t[0]), 0]]
