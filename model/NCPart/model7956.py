# Filename: model212p1p2p1hp_No41.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y1hpk14_t=Y1hpk14(t)
    Y2pk18_t=Y2pk18(t)
    return [[Y2k8_t[1], -(a2*Y1k8_t[0]) + Y2k8_t[0], a4*Y2pk18_t[0]], [a2*Y1k8_t[0] + Y2k8_t[0], -(Y2k8_t[1]), a4*Y2pk18_t[1]], [a3*Y2k4_t[0], a3*Y2k4_t[1], a5*Y1hpk14_t[0]]]
