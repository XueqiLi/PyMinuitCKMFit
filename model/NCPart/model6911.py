# Filename: model212p1h2p1p_No23.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk10_t=Y2pk10(t)
    Y2k12_t=Y2k12(t)
    return [[Y2k8_t[1], -(a2*Y1k8_t[0]) + Y2k8_t[0], -(a4*Y2k12_t[1])], [a2*Y1k8_t[0] + Y2k8_t[0], -(Y2k8_t[1]), a4*Y2k12_t[0]], [a3*Y2pk10_t[0], a3*Y2pk10_t[1], 0]]
