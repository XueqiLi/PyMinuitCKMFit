# Filename: model2121p21h_No78.py
import numpy as np
from ModularForm import *
numberOfParams = 10
def ELMatrix(params):
    g2, g3, g4, g5, g6, g7, a2, a3, a4, a5, tr, ti = params
    t = tr + 1j * ti 
    Y2k12_t=Y2k12(t)
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
...
def NLMatrix(params):
    ...
    Y2k12_t=Y2k12(t)
    Y2pk14_t=Y2pk14(t)
    return [[a3*Y1k12_t[0] - Y2k12_t[0], -(a2*Y1pk12_t[0]) + Y2k12_t[1], -(a5*Y2k4_t[1])], [a2*Y1pk12_t[0] + Y2k12_t[1], a3*Y1k12_t[0] + Y2k12_t[0], a5*Y2k4_t[0]], [a4*Y2pk14_t[1], -(a4*Y2pk14_t[0]), 0]]
