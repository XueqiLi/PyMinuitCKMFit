# Filename: model212p1hp21hp_No4.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk18_t=Y2pk18(t)
    Y1pk20_t=Y1pk20(t)
    return [[a2*Y1hpk14_t[0] - Y2pk14_t[1], -(Y2pk14_t[0]), a5*Y2pk18_t[0]], [-(Y2pk14_t[0]), a2*Y1hpk14_t[0] + Y2pk14_t[1], a5*Y2pk18_t[1]], [a4*Y2IIk16_t[0] + a3*Y2Ik16_t[0], a4*Y2IIk16_t[1] + a3*Y2Ik16_t[1], a6*Y1pk20_t[0]]]
