# Filename: model212p12p1hp_No42.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2k8_t=Y2k8(t)
    Y2pk18_t=Y2pk18(t)
    return [[Y2k8_t[1], -(a2*Y1k8_t[0]) + Y2k8_t[0], a4*Y2pk18_t[1]], [a2*Y1k8_t[0] + Y2k8_t[0], -(Y2k8_t[1]), -(a4*Y2pk18_t[0])], [a3*Y2k4_t[0], a3*Y2k4_t[1], 0]]
