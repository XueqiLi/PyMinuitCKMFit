# Filename: model212p1h2p1hp_No79.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2k8_t=Y2k8(t)
    Y2k12_t=Y2k12(t)
    return [[Y2k8_t[1], -(a2*Y1k8_t[0]) + Y2k8_t[0], -(a4*Y2k12_t[1])], [a2*Y1k8_t[0] + Y2k8_t[0], -(Y2k8_t[1]), a4*Y2k12_t[0]], [a3*Y2k4_t[0], a3*Y2k4_t[1], a5*Y1k8_t[0]]]
