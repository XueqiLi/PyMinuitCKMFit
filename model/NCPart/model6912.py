# Filename: model212p1h2p1p_No24.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk14_t=Y2pk14(t)
    Y1hk18_t=Y1hk18(t)
    return [[Y2k8_t[1], -(a2*Y1k8_t[0]) + Y2k8_t[0], -(a4*Y2k12_t[1])], [a2*Y1k8_t[0] + Y2k8_t[0], -(Y2k8_t[1]), a4*Y2k12_t[0]], [a3*Y2pk14_t[0], a3*Y2pk14_t[1], a5*Y1hk18_t[0]]]
