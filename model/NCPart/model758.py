# Filename: model212121hp_No179.py
import numpy as np
from ModularForm import *
numberOfParams = 10
def ELMatrix(params):
    g2, g3, g4, g5, g6, g7, a2, a3, n2, n3, tr, ti = params
    t = tr + 1j * ti 
    Y2k12_t=Y2k12(t)
    Y1k16_t=Y1k16(t)
    Y2Ik16_t=Y2Ik16(t)
...
def NLMatrix(params):
    ...
    Y2k4_t=Y2k4(t)
    Y2pk10_t=Y2pk10(t)
    return [[Y1k0_t[0], 0, a3*Y2k4_t[0]], [0, Y1k0_t[0], a3*Y2k4_t[1]], [a2*Y2pk10_t[0], a2*Y2pk10_t[1], 0]]
