# Filename: model212121h_No202.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2k12_t=Y2k12(t)
    Y1hpk14_t=Y1hpk14(t)
    return [[a2*Y1k8_t[0] - Y2k8_t[0], Y2k8_t[1], a4*Y2k12_t[0]], [Y2k8_t[1], a2*Y1k8_t[0] + Y2k8_t[0], a4*Y2k12_t[1]], [a3*Y2pk10_t[1], -(a3*Y2pk10_t[0]), a5*Y1hpk14_t[0]]]
