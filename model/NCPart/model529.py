# Filename: model212121h_No242.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2pk14_t=Y2pk14(t)
    Y1hpk18_t=Y1hpk18(t)
    return [[a2*Y1k8_t[0] - Y2k8_t[0], Y2k8_t[1], a4*Y2k12_t[0]], [Y2k8_t[1], a2*Y1k8_t[0] + Y2k8_t[0], a4*Y2k12_t[1]], [a3*Y2pk14_t[1], -(a3*Y2pk14_t[0]), a5*Y1hpk18_t[0]]]
