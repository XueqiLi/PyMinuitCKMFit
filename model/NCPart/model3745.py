# Filename: model2121hp2p1p_No56.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[Y1hpk6_t[0], 0, a4*Y2IIk16_t[0] + a3*Y2Ik16_t[0]], [0, Y1hpk6_t[0], a4*Y2IIk16_t[1] + a3*Y2Ik16_t[1]], [-(a2*Y2k4_t[1]), a2*Y2k4_t[0], a5*Y1hpk14_t[0]]]
