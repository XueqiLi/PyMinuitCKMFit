...
def NLMatrix(params):
    ...
    Y2pk18_t=Y2pk18(t)
    Y1hpk18_t=Y1hpk18(t)
    return [[a2*Y1k8_t[0] - Y2k8_t[0], Y2k8_t[1], a4*Y2pk18_t[1]], [Y2k8_t[1], a2*Y1k8_t[0] + Y2k8_t[0], -(a4*Y2pk18_t[0])], [a3*Y2k8_t[0], a3*Y2k8_t[1], a5*Y1hpk18_t[0]]]
