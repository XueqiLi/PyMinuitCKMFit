# Filename: model2121h2p1p_No27.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[-(Y2pk10_t[1]), -(Y2pk10_t[0]), -(a4*Y2k8_t[1])], [-(Y2pk10_t[0]), Y2pk10_t[1], a4*Y2k8_t[0]], [-(a3*Y2IIk16_t[1]) - a2*Y2Ik16_t[1], a3*Y2IIk16_t[0] + a2*Y2Ik16_t[0], 0]]
