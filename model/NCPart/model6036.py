# Filename: model212p12p1h_No18.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[a2*Y1pk12_t[0] + Y2k12_t[1], -(a3*Y1k12_t[0]) + Y2k12_t[0], a6*Y2pk10_t[1]], [a3*Y1k12_t[0] + Y2k12_t[0], a2*Y1pk12_t[0] - Y2k12_t[1], -(a6*Y2pk10_t[0])], [-(a5*Y2IIk16_t[1]) - a4*Y2Ik16_t[1], a5*Y2IIk16_t[0] + a4*Y2Ik16_t[0], a7*Y1hpk14_t[0]]]
