# Filename: model212121p_No114.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2IIk16_t=Y2IIk16(t)
    Y1pk20_t=Y1pk20(t)
    return [[Y1k0_t[0], 0, a4*Y2IIk16_t[0] + a3*Y2Ik16_t[0]], [0, Y1k0_t[0], a4*Y2IIk16_t[1] + a3*Y2Ik16_t[1]], [-(a2*Y2k4_t[1]), a2*Y2k4_t[0], a5*Y1pk20_t[0]]]
