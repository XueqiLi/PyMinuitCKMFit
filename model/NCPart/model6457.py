# Filename: model212p1h21h_No32.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2IIk16_t=Y2IIk16(t)
    Y1pk20_t=Y1pk20(t)
    return [[Y1hpk6_t[0], 0, a4*Y2pk10_t[1]], [0, Y1hpk6_t[0], -(a4*Y2pk10_t[0])], [-(a3*Y2IIk16_t[1]) - a2*Y2Ik16_t[1], a3*Y2IIk16_t[0] + a2*Y2Ik16_t[0], a5*Y1pk20_t[0]]]
