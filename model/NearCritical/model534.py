# Filename: model21hp21h2p1p_No7.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik20_t=Y2Ik20(t)
    Y2IIk20_t=Y2IIk20(t)
    return [[-(Y2pk10_t[1]), -(Y2pk10_t[0]), -(a4*Y2IIk20_t[1]) - a3*Y2Ik20_t[1]], [-(Y2pk10_t[0]), Y2pk10_t[1], a4*Y2IIk20_t[0] + a3*Y2Ik20_t[0]], [-(a2*Y2k8_t[1]), a2*Y2k8_t[0], a5*Y1hk18_t[0]]]
