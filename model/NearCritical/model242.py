# Filename: model21h21hp21_No1.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik20_t=Y2Ik20(t)
    Y2IIk20_t=Y2IIk20(t)
    return [[a3*Y1k16_t[0] - a2*Y2IIk16_t[0] - Y2Ik16_t[0], a2*Y2IIk16_t[1] + Y2Ik16_t[1], a6*Y2pk14_t[0]], [a2*Y2IIk16_t[1] + Y2Ik16_t[1], a3*Y1k16_t[0] + a2*Y2IIk16_t[0] + Y2Ik16_t[0], a6*Y2pk14_t[1]], [a5*Y2IIk20_t[0] + a4*Y2Ik20_t[0], a5*Y2IIk20_t[1] + a4*Y2Ik20_t[1], a7*Y1hk18_t[0]]]
