# Filename: model21h21hp2p1hp_No1.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y1hk18_t=Y1hk18(t)
    Y1hpk18_t=Y1hpk18(t)
    return [[a2*Y1hpk18_t[0] - Y2pk18_t[1], -(a3*Y1hk18_t[0]) - Y2pk18_t[0], a6*Y2IIk16_t[0] + a5*Y2Ik16_t[0]], [a3*Y1hk18_t[0] - Y2pk18_t[0], a2*Y1hpk18_t[0] + Y2pk18_t[1], a6*Y2IIk16_t[1] + a5*Y2Ik16_t[1]], [a4*Y2pk14_t[0], a4*Y2pk14_t[1], a7*Y1pk12_t[0]]]
