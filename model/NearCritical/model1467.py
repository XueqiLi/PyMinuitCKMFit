# Filename: model2p1hp2p1h2p1_No17.py
import numpy as np
...
def ELMatrix(params):
    ...
    Y2Ik20_t=Y2Ik20(t)
    Y2IIk20_t=Y2IIk20(t)
    return [[Y2k4_t[1], Y2k4_t[0], -(g3*Y2IIk20_t[1]) - g2*Y2Ik20_t[1]], [Y2k4_t[0], -(Y2k4_t[1]), g3*Y2IIk20_t[0] + g2*Y2Ik20_t[0]], [0, 0, g4*Y1k16_t[0]]]
...
def NLMatrix(params):
    ...
    Y2Ik20_t=Y2Ik20(t)
    Y2IIk20_t=Y2IIk20(t)
    return [[Y2k4_t[1], Y2k4_t[0], -(a3*Y2IIk20_t[1]) - a2*Y2Ik20_t[1]], [Y2k4_t[0], -(Y2k4_t[1]), a3*Y2IIk20_t[0] + a2*Y2Ik20_t[0]], [0, 0, a4*Y1hpk18_t[0]]]
