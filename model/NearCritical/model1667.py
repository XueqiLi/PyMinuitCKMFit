# Filename: model2p1p2p1h21hp_No1.py
import numpy as np
...
def ELMatrix(params):
    ...
    Y2IIk16_t=Y2IIk16(t)
    Y2pk18_t=Y2pk18(t)
    return [[g2*Y2IIk16_t[1] + Y2Ik16_t[1], g3*Y1k16_t[0] + g2*Y2IIk16_t[0] + Y2Ik16_t[0], -(g4*Y2k8_t[1])], [-(g3*Y1k16_t[0]) + g2*Y2IIk16_t[0] + Y2Ik16_t[0], -(g2*Y2IIk16_t[1]) - Y2Ik16_t[1], g4*Y2k8_t[0]], [g5*Y2pk18_t[0], g5*Y2pk18_t[1], 0]]
