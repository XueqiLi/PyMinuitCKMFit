# Filename: model2p1p21h21p_No3.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2Ik16_t=Y2Ik16(t)
    Y2IIk16_t=Y2IIk16(t)
    return [[a3*Y1k16_t[0] - a2*Y2IIk16_t[0] - Y2Ik16_t[0], a2*Y2IIk16_t[1] + Y2Ik16_t[1], a5*Y2pk14_t[1]], [a2*Y2IIk16_t[1] + Y2Ik16_t[1], a3*Y1k16_t[0] + a2*Y2IIk16_t[0] + Y2Ik16_t[0], -(a5*Y2pk14_t[0])], [-(a4*Y2k8_t[1]), a4*Y2k8_t[0], 0]]
