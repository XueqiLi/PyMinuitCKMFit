# Filename: model2p1p2p1p2p1p_No1.py
import numpy as np
...
def NLMatrix(params):
    ...
    Y2k12_t=Y2k12(t)
    Y2pk14_t=Y2pk14(t)
    return [[a2*Y1pk12_t[0] + Y2k12_t[1], -(a3*Y1k12_t[0]) + Y2k12_t[0], a5*Y2pk10_t[0]], [a3*Y1k12_t[0] + Y2k12_t[0], a2*Y1pk12_t[0] - Y2k12_t[1], a5*Y2pk10_t[1]], [a4*Y2pk14_t[0], a4*Y2pk14_t[1], a6*Y1k12_t[0]]]
