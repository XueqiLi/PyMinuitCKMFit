...
def ELMatrix(params):
    ...
    return [[eps**9*(YE11Re+1j*YE11Im),eps**9*(YE12Re+1j*YE12Im),eps**9*(YE13Re+1j*YE13Im)],[eps**12*(YE21Re+1j*YE21Im),eps**12*(YE22Re+1j*YE22Im),eps**12*(YE23Re+1j*YE23Im)],[eps**8*(YE31Re+1j*YE31Im),eps**8*(YE32Re+1j*YE32Im),eps**8*(YE33Re+1j*YE33Im)]]
