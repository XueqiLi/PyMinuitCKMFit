...
def ELMatrix(params):
    ...
    return [[eps**7*(YE11Re+1j*YE11Im),eps**7*(YE21Re+1j*YE21Im),eps**7*(YE31Re+1j*YE31Im)],[eps**7*(YE12Re+1j*YE12Im),eps**7*(YE22Re+1j*YE22Im),eps**7*(YE32Re+1j*YE32Im)],[eps**11*(YE13Re+1j*YE13Im),eps**11*(YE23Re+1j*YE23Im),eps**11*(YE33Re+1j*YE33Im)]]
