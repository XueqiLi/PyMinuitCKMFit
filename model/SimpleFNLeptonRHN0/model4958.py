# Input String: 4958: {{-3, -3, -3}, {4, 4, 8}, {0, 0, 0}}
import numpy as np
numberOfParams = 27
eps = 0.17
def ELMatrix(params):
    ...
    return [[eps**7*YD(1,1],eps**7*YD(2,1],eps**11*YD(3,1]],[eps**7*YD(1,2],eps**7*YD(2,2],eps**11*YD(3,2]],[eps**7*YD(1,3],eps**7*YD(2,3],eps**11*YD(3,3]]]
